<template>
    <div class="input-group mb-3">
        <input id="search-box" type="text" class="form-control" placeholder="Pesquisar cliente..."
            autocomplete="off"
            v-model="query"
            @keydown.down="down"
            @keydown.up="up"
        ...
        <ul v-show="hasItems" class="list-group" style="z-index: 999; position: absolute;top: 38px;width: 100%;">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="customerModalLabel">Criar novo usuário</h5>
